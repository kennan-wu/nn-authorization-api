...
public class JwtDecoderConfigTest {
    ...
    @Bean
    public NimbusJwtDecoder mockJwtDecoder() {
        return Mockito.mock(NimbusJwtDecoder.class);
    }

    @Bean
    public JwtService jwtService(NimbusJwtDecoder mockGoogleJwtDecoder, NimbusJwtDecoder mockJwtDecoder) {
        return new JwtService(mockGoogleJwtDecoder, mockJwtDecoder);
    }
}
